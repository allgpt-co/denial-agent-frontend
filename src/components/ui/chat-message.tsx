...
const chatBubbleVariants = cva(
    "group/message relative break-words rounded-2xl p-4 text-sm transition-all duration-300 w-fit max-w-full",
    {
        variants: {
            variant: {
    ...
    return (
        <div className={cn(
            ...
            <div className={cn(
                ...
                {/* Message Content */}
                <div className={cn(chatBubbleVariants({ variant, animation }), `variant-${variant}`)} data-role={variant}>
