...
const COMPONENTS = {
    ...
    a: withClass("a", "text-primary underline underline-offset-2 hover:opacity-80 transition-opacity break-all [[data-role=user]_&]:text-inherit"),
    ...
    code: ({ children, className, node, ...rest }: any) => {
        ...
        if (isJson) {
            return <JsonChip content={content} />
        }
